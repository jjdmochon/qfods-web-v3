...
export const LAB_REACTION_STEPS: LabReactionStep[] = [
  {
    ...
    reactionSchemeImg: '/practicas/schemes/reaccion_1_naftoximetiloxirano_clean.png',
    schemeFullUrl: '/practicas/schemes/esquema_1_naftoximetiloxirano_completo.png',
    schemeCleanUrl: '/practicas/schemes/reaccion_1_naftoximetiloxirano_clean.png',
  ...
  },
  {
    ...
    reactionSchemeImg: '/practicas/schemes/reaccion_2_propranolol_clean.png',
    schemeFullUrl: '/practicas/schemes/esquema_2_propranolol_completo.png',
    schemeCleanUrl: '/practicas/schemes/reaccion_2_propranolol_clean.png',
  ...
  },
  {
    ...
    reactionSchemeImg: '/practicas/schemes/reaccion_3_hantzsch_dhpp_clean.png',
    schemeFullUrl: '/practicas/schemes/esquema_3_hantzsch_dhpp_completo.png',
    schemeCleanUrl: '/practicas/schemes/reaccion_3_hantzsch_dhpp_clean.png',
...
export const COMPOUND_SPECTRA_DATA: Record<string, CompoundSpectra> = {
  propranolol: {
    ...
    mw: 259.34,
    smiles: 'CC(C)NCC(O)COc1cccc2ccccc12',
    r1hImageHorizontal: '/practicas/spectra/propranolol_1h_nmr_horizontal.png',
    r1hImagePortrait: '/practicas/spectra/propranolol_1h_nmr_portrait.png',
    r13cImageHorizontal: '/practicas/spectra/propranolol_13c_nmr_horizontal.png',
    r13cImagePortrait: '/practicas/spectra/propranolol_13c_nmr_portrait.png',
    deptImageHorizontal: '/practicas/spectra/propranolol_dept135_horizontal.png',
    deptImagePortrait: '/practicas/spectra/propranolol_dept135_portrait.png',
    msImageHorizontal: '/practicas/spectra/propranolol_hr_ms_horizontal.png',
    msImagePortrait: '/practicas/spectra/propranolol_hr_ms_portrait.png',
    peaks1H: [
  ...
  dhpp: {
    ...
    mw: 301.34,
    smiles: 'COC(=O)C1=C(C)NC(C)=C(C1c2ccccc2)C(=O)OC',
    r1hImageHorizontal: '/practicas/spectra/dhpp_1h_nmr_horizontal.png',
    r1hImagePortrait: '/practicas/spectra/dhpp_1h_nmr_portrait.png',
    r13cImageHorizontal: '/practicas/spectra/dhpp_13c_nmr_horizontal.png',
    r13cImagePortrait: '/practicas/spectra/dhpp_13c_nmr_portrait.png',
    deptImageHorizontal: '/practicas/spectra/dhpp_dept135_horizontal.png',
    deptImagePortrait: '/practicas/spectra/dhpp_dept135_portrait.png',
    msImageHorizontal: '/practicas/spectra/dhpp_hr_ms_horizontal.png',
    msImagePortrait: '/practicas/spectra/dhpp_hr_ms_portrait.png',
    peaks1H: [
  ...
  nifedipina: {
    ...
    mw: 346.33,
    smiles: 'COC(=O)C1=C(C)NC(C)=C(C1c2ccccc2[N+](=O)[O-])C(=O)OC',
    r1hImageHorizontal: '/practicas/spectra/nifedipina_1h_nmr_horizontal.png',
    r1hImagePortrait: '/practicas/spectra/nifedipina_1h_nmr_portrait.png',
    r13cImageHorizontal: '/practicas/spectra/nifedipina_13c_nmr_horizontal.png',
    r13cImagePortrait: '/practicas/spectra/nifedipina_13c_nmr_portrait.png',
    deptImageHorizontal: '/practicas/spectra/nifedipina_dept135_horizontal.png',
    deptImagePortrait: '/practicas/spectra/nifedipina_dept135_portrait.png',
    msImageHorizontal: '/practicas/spectra/nifedipina_hr_ms_horizontal.png',
    msImagePortrait: '/practicas/spectra/nifedipina_hr_ms_portrait.png',
    peaks1H: [
